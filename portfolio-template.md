...
<!-- Table des matières: sera générée automatiquement par l'outil d'export (voir README) -->

# Table des matières

<!-- Placeholder de génération de TOC. Avec Pandoc: ajouter --toc à la commande. Avec Word/Google Docs: insérer la table des matières après import. -->
...
## Compétence clé 2 — Développement (C/C#/Python/JS)
